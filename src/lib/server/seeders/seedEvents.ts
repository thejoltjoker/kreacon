	...
	const values: InsertEvent[] = [
		{
			...
			submissionsOpenAt: new Date('2023-06-01T00:00:00Z'),
			submissionsCloseAt: new Date('2025-06-15T23:59:59Z'),
			votingOpenAt: new Date('2023-06-16T00:00:00Z'),
		...
		},
		{
			...
			submissionsOpenAt: new Date('2023-12-01T00:00:00Z'),
			submissionsCloseAt: new Date('2025-12-15T23:59:59Z'),
			votingOpenAt: new Date('2023-12-16T00:00:00Z'),
